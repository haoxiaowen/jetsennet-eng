...
jetsennet.importCss("bootstrap/daterangepicker-bs3");  
 ...
 var joinTables =[["PPN_RENT_OUT", "au", "t.OUT_ID = au.OUT_ID", jetsennet.TableJoinType.Inner], ["PPN_RENT_OBJ", "ob", "ob.OBJ_CODE= t.ITEM_OBJ_CODE", jetsennet.TableJoinType.Inner]];
  var resultFields="sum(ITEM_OBJ_NUM) a1,sum(ITEM_OBJ_UOM) a2,ITEM_OBJ_TYPE";
  var groupFields="t.ITEM_OBJ_TYPE";


  var jsontotal=SYSDAO.queryObjs("commonXmlQuery", "ITEM_ID", "PPN_RENT_OUT_ITEM", "t",joinTables ,conditions, "sum(ITEM_OBJ_NUM) a1,sum(ITEM_OBJ_UOM) a2,ITEM_OBJ_TYPE",null,"t.ITEM_OBJ_TYPE")
