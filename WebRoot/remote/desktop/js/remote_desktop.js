...
RemoteDesktop.View = function(/* canvas */canvas,/*String*/ip,/*String*/ports) {
	...
	//$(canvas).bind('mouseover',function(){$(canvas).css("cursor","none");});
	...
	this.logout = function(){
		var parameter = {CtlCode:"00005",address:ipAddress,port:port};
        var args = JSON.stringify(parameter);
        //alert(args);
        var result = null;
       	$.ajax({
	...
	this.auth_more = function(){
		var parameter = {CtlCode:"00004",address:ipAddress,port:port,auth:"170101"};
        var args = JSON.stringify(parameter);
        //alert(args);
        var result = null;
       	$.ajax({
	...
	this.auth_cancal = function(){
		var parameter = {CtlCode:"00004",address:ipAddress,port:port,auth:"160101"};
        var args = JSON.stringify(parameter);
        //alert(args);
        var result = null;
       	$.ajax({
