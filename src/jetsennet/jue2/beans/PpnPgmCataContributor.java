 ...
 * 文件：jetsennet.jue2.beans.PpnPgmCataContributor.java
 * 日 期：Wed Aug 31 19:43:11 CST 2016
 */
 ...
 * @version 1.0.0
 */
@ClassMapping(tableName = "PPN_PGM_CATA_CONTRIBUTOR", keyGenerator = "uuid")
public class PpnPgmCataContributor implements Serializable {
	...
	/** foreign key field of PPN_PGM_CATA.CATA_ID */
	...
	public PpnPgmCataContributor() {
		super();
	}

	public PpnPgmCataContributor(String contrId) {
		this.contrId = contrId;
	}

	public PpnPgmCataContributor(String contrField1, String contrField2) {
	...
	public boolean equals(Object o) {
		if ((o == null) || !(o instanceof PpnPgmCataContributor)) {
			return false;
		}
		PpnPgmCataContributor other = (PpnPgmCataContributor)o;
