 ...
 * 文件：jetsennet.jue2.beans.PpnTransDsUser.java
 ...
 * @version 1.0.0
 */
@ClassMapping(tableName = "PPN_TRANS_DS_USER", keyGenerator = "uuid")
public class PpnTransDsUser implements Serializable {
	...
	public PpnTransDsUser() {
		super();
	}

	public PpnTransDsUser(String userId) {
		this.userId = userId;
	}

	public PpnTransDsUser(String userCode, String userMobileTel, String userName, String userRole, String userTel) {
	...
	public boolean equals(Object o) {
		if ((o == null) || !(o instanceof PpnTransDsUser)) {
			return false;
		}
		PpnTransDsUser other = (PpnTransDsUser)o;
		if (null == this.userId) {
